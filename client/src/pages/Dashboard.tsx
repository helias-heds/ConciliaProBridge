...
const mockTransactions: Transaction[] = [
  {
    ...
    name: "Pagamento Fornecedor ABC",
    description: "Pagamento mensal referente aos serviços prestados",
    value: 1500.00,
    status: "reconciled",
    confidence: 98,
  },
  {
    ...
    name: "Recebimento Cliente XYZ",
    description: "Recebimento da fatura #1234",
    value: 3200.50,
    status: "reconciled",
    confidence: 95,
  },
  ...
  },
  {
    ...
    name: "Conta de Luz",
    description: "Conta de energia elétrica do mês",
    value: 450.00,
  ...
  },
  {
    ...
    name: "Taxa Bancária",
    description: "Taxa de manutenção da conta corrente",
    value: 35.00,
  ...
  },
  {
    ...
    description: "Tarifa mensal do pacote de serviços",
    value: 25.00,
    status: "pending-statement",
  },
];
